  ...
  (
    ...
    return (
      <>
        ...
        <div className="relative inline-block group pointer-events-none w-auto">
          <div
            className={cn(
              "absolute pointer-events-none transition-all ease-out duration-200 z-10",
              active ? "inset-0 opacity-100" : "inset-[2px] opacity-0 group-hover:inset-0 group-hover:opacity-100"
            )}
          ...
          >
            ...
            >
              <path
                ...
                strokeDasharray="6,4"
                strokeDashoffset="0"
                className={active ? "animate-[dash-flow_1s_linear_infinite]" : "group-hover:animate-[dash-flow_1s_linear_infinite]"}
              />
            </svg>
          </div>
          <Comp
